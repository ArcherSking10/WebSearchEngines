...
//        String splitString = pair[1];
        String query[] = pair[1].split("\\+");
//        System.out.println("Testing query = " + query[0]);
        StringBuffer stringBuffer = new StringBuffer ();
        for (int i=0; i < query.length; i++) {
            stringBuffer.append(query[i] + " ");
        }
        String queryString = stringBuffer.toString().trim();
        ...
        responseBody.write(queryString.getBytes());
        responseBody.close();
    }
}
